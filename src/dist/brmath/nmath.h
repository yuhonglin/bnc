...
/* Remap for JAGS */
#define norm_rand br_norm_rand
#define unif_rand br_unif_rand
#define exp_rand  br_exp_rand
...
double  br_d1mach(int);
double	br_gamma_cody(double);
...
#define bd0       	br_bd0
#define chebyshev_eval	br_chebyshev_eval
#define chebyshev_init	br_chebyshev_init
#define gammalims	br_gammalims
#define lfastchoose	br_lfastchoose
#define lgammacor	br_lgammacor
#define stirlerr       	br_stirlerr
