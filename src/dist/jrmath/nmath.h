...
/* Remap for JAGS */
#define norm_rand bnc_norm_rand
#define unif_rand bnc_unif_rand
#define exp_rand  bnc_exp_rand
...
double  bnc_d1mach(int);
double	bnc_gamma_cody(double);
...
#define bd0       	bnc_bd0
#define chebyshev_eval	bnc_chebyshev_eval
#define chebyshev_init	bnc_chebyshev_init
#define gammalims	bnc_gammalims
#define lfastchoose	bnc_lfastchoose
#define lgammacor	bnc_lgammacor
#define stirlerr       	bnc_stirlerr
